...
export default function DateInvite() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-pink-300 via-pink-400 to-pink-500 p-6 transition-all duration-700 relative overflow-hidden">
      ...
      {/* Celebration Popup */}
      {celebrate && (
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-pink-600 bg-opacity-90 backdrop-blur-sm animate-fadeIn">
